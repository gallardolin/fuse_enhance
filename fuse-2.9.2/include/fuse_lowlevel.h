...
struct fuse_lowlevel_ops {
	 ...
	 * @param name to remove
	 */
	void (*syncdelete) (fuse_req_t req, fuse_ino_t parent, const char *name, int *control_flags);
	/**
	 * Remove a directory
	 *
	 ...
	 * @param name to remove
	 */
	void (*syncrmdir) (fuse_req_t req, fuse_ino_t parent, const char *name, int *control_flags);
	/**
